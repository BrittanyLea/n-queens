 ...
 */
    ...
    hasRowConflictAt: function(rowIndex) {
      //iterate through array at rowIndex blah
    ...
    hasMajorDiagonalConflictAt: function(majorDiagonalColumnIndexAtFirstRow) {
      ...
      var counter = 0;
      for(var i = 0; i < length; i++) {
        //check if space is actually on board
        if(column+i >= 0 && column+i < length) {
          //check space for piece
          if(this.get(i)[column+i]) {
            counter++;
          }
        }
      }
    ...
    hasMinorDiagonalConflictAt: function(minorDiagonalColumnIndexAtFirstRow) {
      ...
      for (var i = 0; i < length; i++) {
        if(column+i >= 0 && column+i < length) {
          if (this.get(length-(i+1))[column+i]) {
            counter++;
          }
        }
      }
